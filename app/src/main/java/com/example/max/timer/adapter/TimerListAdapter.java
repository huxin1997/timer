...
public class TimerListAdapter extends RecyclerView.Adapter<TimerListAdapter.TimerViewHolder> {
    ...
    private OnDataIsNothingListener mOnDataIsNothingListener;
                        ...
                        .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (b) {
                                    ...
                                    if (mOnDataIsNothingListener != null) {
                                        if (data_.isEmpty())
                                            mOnDataIsNothingListener.dataEmpty(true);
                                        else
                                            mOnDataIsNothingListener.dataEmpty(false);
                                    }
                                } else {
...
//            swipeMenuLayout= (SwipeMenuLayout) itemView.findViewById(R.id.card_view_main_container);
    ...
    public interface OnDataIsNothingListener {
        void dataEmpty(boolean isEmpty);
    }

    public void setOnDataEmptyListener(OnDataIsNothingListener mOnDataEmptyListener) {
        this.mOnDataIsNothingListener = mOnDataEmptyListener;
    }
